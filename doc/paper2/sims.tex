...
observables and train machine learning algorithms. The suite includes enough
...
length $b=0.2$ on the CDM + baryon distribution. We impose a halo mass limit 
of $M_{\rm lim} = 3.2\times 10^{13} h^{-1}M_\odot$. For the fiducial cosmology, 
the halo catalogs have ${\sim}156,000$ halos ($\bar{n}_h \sim 1.56 \times 10^{-4}~h^3{\rm Gpc}^{-3}$) 
with $\bar{n} P_0(k=0.1)\sim 3.23$.  We refer readers to~\cite{villaescusa-navarro2019}
and~\cite{hahn2020} for further details on the \quij simulations. The

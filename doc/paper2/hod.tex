...
\begin{center}
    ...
    \caption{
        ...
        the standard \cite{zheng2007} HOD model. The halo mass limit of the \quij 
        simulations,  $M_{\rm lim} = 3.2\times 10^{13} h^{-1}M_\odot$ (black dashed), 
        prevent us from adopting the best-fit HOD parameters of the SDSS $M_r < -21.5$ 
        (blue dashed) or $< -22.$ sample (orange dashed).
    }\label{fig:hod}
\end{center}
\end{figure}
...
\cite{zentner2016} and \cite{vakili2019} examined evidence for assembly bias 
in the observed clustering measurements of the Sloan Digital Sky Survey (SDSS) DR 7
main galaxy sample. \todo{short description of the paper and how they compare 
with a model with assembly bias}. 

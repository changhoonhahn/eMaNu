...
\section{Halo Occupation Distribution: The Molino Mock Galaxy Catalogs} \label{sec:hod}  
...
The \molino~galaxy mock catalogs used in this paper are constructed using the
...
\eeq
You can maybe say that derivatives are converged with this choice. Or that Fisher
doesnt change if you vary these values
...
The \molino~galaxy catalogs are publicly available at \todo{where to access the galaxy catalogs}.

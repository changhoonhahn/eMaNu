...
Combining $\Pgl$ and $\Bg$, we get the following $1\sigma$ constraints for 
 $\Om$, $\Ob$, $h$, $n_s$, $\sig$, and $\smnu$: \ch{numbers numbers}. 
{\em By combining $\Pgl$ and $\Bg$, we improve $\Om$, $\Ob$, $h$,
...
including $\Bg$ to $\Pgl$ and planck would likely be larger. 

% comparison to literature 

%Compare to halo paper 
signal-to-noise is lower for the galaxy power and bispectrums than

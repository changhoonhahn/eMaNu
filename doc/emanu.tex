...
We present the redshift-space halo bispectrum of the HADE simulations measured using the 
estimator above in Figures~\ref{fig:bk_shape} and~\ref{fig:bk_amp}. Figure~\ref{fig:bk_shape}
plot $B(k_1, k_2, k_3)$ as a function of $k_2/k_1$ and $k_3/k_1$, which describe the triangle 
configuration 

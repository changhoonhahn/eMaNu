...
\begin{center} 
    \begin{tabular}{cccccccccc} \toprule
        ...
        $P_0$   & 0.2 & $\pm0.452$ & $\pm0.0540$ & $\pm0.0282$ & $\pm0.367$ & $\pm0.380$ & $\pm0.1137$ & $\pm0.869$ & $\pm6.504$\\
                & 0.3 & $\pm0.285$ & $\pm0.0393$ & $\pm0.0165$ & $\pm0.207$ & $\pm0.233$ & $\pm0.0760$ & $\pm0.405$ & $\pm2.518$\\
                & 0.4 & $\pm0.203$ & $\pm0.0355$ & $\pm0.0140$ & $\pm0.180$ & $\pm0.210$ & $\pm0.0632$ & $\pm0.236$ & $\pm1.192$\\
                & 0.5 & $\pm0.167$ & $\pm0.0311$ & $\pm0.0116$ & $\pm0.150$ & $\pm0.177$ & $\pm0.0513$ & $\pm0.167$ & $\pm0.758$\\
        $B_0$   & 0.2 & $\pm0.1113$ & $\pm0.0334$ & $\pm0.01063$ & $\pm0.1352$ & $\pm0.1592$ & $\pm0.0556$ & $\pm0.3052$ & $\pm1.544$\\
                & 0.3 & $\pm0.0589$ & $\pm0.0217$ & $\pm0.00511$ & $\pm0.0677$ & $\pm0.0819$ & $\pm0.0245$ & $\pm0.1560$ & $\pm0.734$\\
                & 0.4 & $\pm0.0347$ & $\pm0.0151$ & $\pm0.00296$ & $\pm0.0437$ & $\pm0.0495$ & $\pm0.0161$ & $\pm0.0913$ & $\pm0.385$\\
                & 0.5 & $\pm0.0256$ & $\pm0.0111$ & $\pm0.00216$ & $\pm0.0316$ & $\pm0.0345$ & $\pm0.0138$ & $\pm0.0718$ & $\pm0.274$\\[3pt]
    \hline
...
\begin{figure}
\begin{center}
    \includegraphics[width=0.9\textwidth]{figs/quijote_Fisher_kmax_dmnu_fin_bMmin.pdf} %quijote_Fisher_dmnu_fin_sigmakmax_freeMmin.pdf} 
    ...
    improves constraints by factors of $\sim 2$, 3, 3, 2.5, 3, and $5$, for $\Om$, 
    $\Ob$, $h$, $n_s$, $\sig$, and $\smnu$ respectively, over the power spectrum.}
\label{fig:fish_kmax}
\end{center}
\end{figure}
...
nonlinear regime and rely on fewer assumptions and approximations. In fact, these
$N$-body simulation estimated derivatives are the key ingredients that enables us 
to quantify the information content of the redshift-space bispectrum in the non-linear 
regime for the first time. We discuss subtleties of the bispectrum derivatives in 
Appendix~\ref{sec:numerical} and discuss tests of convegence in Appendix~\ref{sec:numerical}. 
...
monopole with the same $k_{\rm max}$ for comparison (blue). The mark the 
$68\%$ and $95\%$ confidence interals with the contours. We include in our Fisher 
...
over the power spectrum for both $k_{\rm max} = 0.2$ and $0.5~h/{\rm Mpc}$.
We list the precise marginalized Fisher parameter constraints of both 
cosmological and nuisance parameters for $P_0$ and $B_0$ in Table~\ref{tab:forecast}. 
For $k_{\rm max} = 0.5~h/{\rm Mpc}$, the bispectrum improves the marginalized
constraints, $\sigma_\theta$ of $\Om$, $\Ob$, $h$, $n_s$, and $\sig$ by factors 
of $\sim$3, 5, 5, 5, and 4 over the power spectrum. {\em For $\smnu$, the 
bispectrum improves the constraint from $\sigma_{\smnu}{=}~0.167$ to 
$0.0256$eV --- over a factor of 6 improvement over the power spectrum}.
...
larger at higher $k_{\rm max}$. However, even at $k_{\rm max} = 0.2~h/{\rm Mpc}$, 
we find that the bispectrum improves $\sigma_\theta$ by factors of 
$\sim 2$, 3, 3, 2.5, 3, and $5$ for $\Om$, $\Ob$, $h$, $n_s$, $\sig$, and 
$\smnu$ respectively. Although limited by the $k_{\rm max}$ range, Figure~\ref{fig:fish_kmax} 
suggests that eventually on large scales, $k_{\rm max}\lesssim 0.075~h/{\rm Mpc}$, 
the $P_0$ $\sigma_\theta$ crosses over the $B_0$ $\sigma_\theta$. In other 
words, $P_0$ has more constraining power than $B_0$ for $k_{\rm max}\lesssim 0.075~h/{\rm Mpc}$, 
as expected on linear scales. 

\ch{emphasize that this is only for a 1 Gpc box so our constraints will be so much better}

discussing the results:

{\bf Q}: How does the bispectrum do so much better?  \\ 
{\bf A}: The bispectrum does better than the power spectrum because it's better at breaking
...
the B, ($\partial \log B / \partial \smnu$) shows very little triangle shape dependence.  
redshift-space helps us out (refer to appendix?)

{\bf Q}: Is this consistent with previous work --- i.e. S/N calculations?  \\
{\bf A}: The unmarginalized constraints are consistent with S/N calculations of scoccimarro 
and more recently chan. 

...
%In cosmology, we are ultimately interested in how well the measurements of the polyspectra can put constraints on the cosmological parameters, and this can be esti- mated using the Fisher analysis. Furthermore, it has pre- viously been shown that the Fisher analysis results may not be easily interpreted from a simpler signal-to-noise analysis.

...
Going beyond signal-to-noise calculations, a number of previous works have 
\begin{itemize}
    \item Scoccimarro, Sefusatti \& Zaldarriaga 2004: 
    \item Sefusatti \& Komatsu 2007
    \item Song, Taruya \& Oka 2015
    \item Tellarini et al. 2016
    \item Yamauchi, Yokoyama \& Takahashi 2017a
    \item Karagiannis et al. 2018
\end{itemize} 
There are many forecasts where they fix the main cosmological parameters and look at 
only bias and non-Gaussianity. 
We're better than these forecasts because we include all the cosmological 

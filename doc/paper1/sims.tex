...
\includegraphics[width=0.9\textwidth]{figs/haloPlk_rsd_ratio.pdf}
    ...
    suite, which includes simulations with $\smnu = 0.0$, 0.06, 0.10, 
    ...
    the halo $P_\ell$ increases with higher $\smnu$ because cosmologies 
    with higher $\smnu$ have lower $\sig$, which translates into larger 
    halo bias for a fixed halo mass limit. 

...
\begin{abstract}
    ...
    down to nonlinear scales entirely from simulations. For $k_{\rm max}{=}0.5~\mpc$, the bispectrum 
    ...
    over bias parameters to the next paprer of the series, these constraints are derived for a 

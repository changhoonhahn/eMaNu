...
\begin{abstract}
    ...
    $\Om$, $\Ob$, $h$, $n_s$, and $\sig$ constraints \ch{1.9, 2.6, 3.1, 3.6, and 2.6} times tighter than the 
    power spectrum. For $\smnu$, the bispectrum improves the 1$\sigma$ constraint from 
    \ch{0.2968 to 0.0572 eV --- over 5 times tighter than the power spectrum}. Even with priors from {\em Planck}, 

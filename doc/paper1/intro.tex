...
Afterwards, we explore forecasts with different sets of nuisance and bias parameters 
as well as with and without priors from Planck and discuss some caveats of our 
results. This paper is the first of a series of papers that aim to demonstrate the potential 
...
subsequent paper, we will include a more realistic galaxy bias model in our forecast 
that describes the distribution of central and satellite galaxies in halos to 
quantify the full information content of the {\em galaxy} bispectrum. 
In the series, we 

...
\ch{
In their forecast that includes $\smnu$, \cite{chudaykin2019} find that 
including the bispectrum significantly improves constraints for $\smnu$. 
Limitations in their analytic modeling, covariances, and treatement of 
theoretical errors, however, prevent them from accurately quantifying the
information content of the nonlinear 
scales (Section~\ref{sec:forecasts}). No work to date has quantified the total 
information content and constraining power of the full bispectrum down to
nonlinear scales --- especially for $\smnu$. 
}
...
of galaxy bispectrum analyses in constraining $\smnu$.
\ch{
In particular, with this series we aim to establish the potential of galaxy 
bispectrum analyses using simulation based emulation models that extend to nonlinear
scales to constrain cosmological parameters including $\smnu$ for upcoming galaxy surveys.
}
...
and the halo catalogs cosntructed from them. We then describe in Section~\ref{sec:bk}, 

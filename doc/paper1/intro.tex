...
\edt{
    In this paper, we focus on the halo bispectrum and consider some simple galaxy 
    bias models. Cosmological parameter constraints, however, are derived from the 
    distribution of galaxies. Thus, in the subsequent paper, we will include a more 
    realistic bias model  in our forecasts, one that describes the distribution of 
    central and satellite galaxies in halos,
}

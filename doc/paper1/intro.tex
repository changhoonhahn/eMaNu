...
\edt{
Only the upcoming CLASS experiment aims to improve $\tau$ constraints~\citep{watts2018}.
}
...
potential to precisely measure $\tau$, have yet to be confirmed. CMB data, 
however, is not the only way to improve $\smnu$ constraints. The imprint of 
...
\edt{
We then explore forecasts with different sets of nuissance and bias parameters 

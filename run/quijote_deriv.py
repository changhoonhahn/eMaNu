...
def dBdtheta_fiducial(theta, z=0): 
    ...
    if theta == 'Mnu': 
        for i_dmnu, dmnu in enumerate(['fin', 'fin0', 'p', 'pp', 'ppp']): 
            ...
            _, _, _, dlogbk = Forecast.quijote_dBkdtheta(theta, log=True, z=z, dmnu=dmnh, flag=None, rsd=0, Nfp=None)
...
def dBdtheta_real(theta, z=0): 
    ...
    if theta == 'Mnu': 
        for i_dmnu, dmnu in enumerate(['fin', 'fin0', 'p', 'pp', 'ppp']): 
            ...
            _, _, _, dlogbk = Forecast.quijote_dBkdtheta(theta, log=True, z=z, dmnu=dmnh, flag=None, rsd='real', Nfp=None)
...
def dBdtheta_ncv(theta, z=0, rsd=0): 
    ...
    if theta == 'Mnu': 
        for i_dmnu, dmnu in enumerate(['fin', 'fin0', 'p', 'pp', 'ppp']): 
            ...
            _, _, _, dlogbk = Forecast.quijote_dBkdtheta(theta, log=True, z=z, dmnu=dmnh, flag='ncv', rsd=rsd, Nfp=None)
...
def dBdtheta_reg(theta, z=0, rsd=0): 
    ...
    if theta == 'Mnu': 
        for i_dmnu, dmnu in enumerate(['fin', 'fin0', 'p', 'pp', 'ppp']): 
            ...
            _, _, _, dlogbk = Forecast.quijote_dBkdtheta(theta, log=True, z=z, dmnu=dmnh, flag='reg', rsd=rsd, Nfp=None)
